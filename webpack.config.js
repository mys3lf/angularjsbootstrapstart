...
module.exports = function makeWebpackConfig() {
  ...
  config.module = {
    ...
    },
    {
      ...
      // Transpile .json files using babel-loader
      // Compiles ES6 and ES7 into ES5 code
      test: /\.json$/,
      loader: 'json-loader'
      //  exclude: /node_modules/
    },
    {
      ...
      // Transpile .ts files using babel-loader
      test: /\.tsx?$/,
      loader: 'ts-loader'
    },
  ...
  if (!isTest) {
    ...
    config.plugins.push(
      ...
      new ExtractTextPlugin('[name].bundle.css', { disable: !isProd })
    )
  }
  ...
  if (isProd) {
    config.plugins.push(
      ...
      // Reference: https://github.com/kevlened/copy-webpack-plugin
      new CopyWebpackPlugin([{
        from: __dirname + '/src/website/views/content'
      }])
    )
  }
   ...
   */
  config.devServer = {
    contentBase: ['./src/public', './src/website/views/content'],
    stats: 'minimal'
  };
